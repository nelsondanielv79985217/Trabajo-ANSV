...
35 documentos relevados en la raíz del repo (30 PDF, incluido uno con extensión `.PDF` en mayúsculas, y 5 DOCX): **10 ingeridos** — bundle completo del PR-06 (6) + Ley 769/2002, Ley 1310/2009, Ley 1383/2010 y Ley 1503/2011 (4 de la normativa nacional) — y **25 pendientes de ingest**. La agrupación de las pendientes es solo por lo que indica el nombre de archivo — no implica haber leído el contenido (regla de incertidumbre, `CLAUDE.md`).
...
#### Normativa nacional — leyes, decretos, CONPES, resoluciones (9 restantes de 13)
