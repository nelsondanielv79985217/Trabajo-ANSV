...
35 documentos relevados en la raíz del repo (30 PDF, incluido uno con extensión `.PDF` en mayúsculas, y 5 DOCX): **9 ingeridos** — bundle completo del PR-06 (6) + Ley 769/2002, Ley 1310/2009 y Ley 1383/2010 (3 de la normativa nacional) — y **26 pendientes de ingest**. La agrupación de las pendientes es solo por lo que indica el nombre de archivo — no implica haber leído el contenido (regla de incertidumbre, `CLAUDE.md`).
...
#### Normativa nacional — leyes, decretos, CONPES, resoluciones (10 restantes de 13)
