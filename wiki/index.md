...
**Estado general (2026-09-25):** 18 de 45 fuentes con página propia en `fuentes/` (PR-06 sigue `incierto` por falta de citación por página; las demás, ingeridas con citación completa). La categoría **Marco normativo queda completa (11/11)**. 3 entidades (DCI, ANSV, Corporación Fondo de Prevención Vial) y 5 conceptos (jerarquía documental del proceso DCI; Plan Estratégico de Seguridad Vial — PESV; Organismos y autoridades de tránsito; Genealogía normativa de "asistencia técnica"; Sistema Seguro — enfoque de la política de seguridad vial) creados. Las 27 fuentes restantes están relevadas por nombre de archivo únicamente; ninguna fue leída todavía. *Nota (2026-09-25): la wiki ya no se construye como insumo de tesis, sino como base de conocimiento para agentes de asesoría del usuario en la DCI/ANSV — ver `CLAUDE.md` y `log.md`.* *(Corrección 2026-09-24: el conteo inicial de "46 fuentes" del setup era erróneo — son 45; ver `log.md`.)*
...
### Planeación sectorial y política pública (6, 1 ingerida)
...
- Documento técnico de soporte Mintransporte- PNSV 2022-2031.pdf — (pendiente-ingest)
- PLAN 70D SECTOR TRANSPORTE.pdf — (pendiente-ingest)
- Plan estrategico de control  SIT Resolucion 10110_231205_123130.pdf — (pendiente-ingest)
- manual-metodologico operacion estadistica FPSV.pdf — (pendiente-ingest)
- ANEXO TÉCNICO PLAN 365.pdf — (pendiente-ingest)

### Protocolos operativos y Plan 365 (4)

- Protocolo_Practicas_Seguras_Motociclistas.pdf — (pendiente-ingest)
- CIRCULAR CONJUNTA PLAN 365 ANSV_VF.pdf — (pendiente-ingest)
- ANÁLISIS DE LOS REPORTES PRESENTADOS POR LOS ORGANISMOS DE TRÁNSITO PLAN 365.pdf — (pendiente-ingest)
- circular externa 20244000000157  VIDEOS INFRACCIONES Mintransporte.pdf — (pendiente-ingest)

### Correspondencia oficial / oficios (7)

- 20254000114441_Oficio_ANSV_2024 Super y Procuraduría VR.pdf — (pendiente-ingest)
- OFICIO CONVOCATORIA SOCIALIZACIÓN 14-11-2025.docx — (pendiente-ingest)
...
- ANSV-CON-MG-01_V4_manual_unificado_de_contratacion_ANSV.pdf — (pendiente-ingest)
...
- [Genealogía normativa de "asistencia técnica"](conceptos/genealogia-asistencia-tecnica.md) — Línea de tiempo del término desde la Ley 769/2002 (2002, autoridades de tránsito en general) hasta PR-06 (2025, DCI), pasando por el Decreto 2851/2013 (2013, Mineducación) y la reforma del Art. 7° Par. 3 del propio Código (ANSV). Incluye la definición de referencia AT/ATT del CONPES 4091 (2022, DNP) — la más autorizada del corpus, aunque no menciona a la ANSV/DCI. Hallazgo: el concepto no es una invención de la DCI ni un término unívoco; lo nuevo en 2025 es el procedimiento, no el término.
- [Sistema Seguro — enfoque de la política de seguridad vial](conceptos/sistema-seguro-enfoque-politica-seguridad-vial.md) — Paradigma internacional (*Safe System*) adoptado por la Ley 2251/2022 para toda la política pública de seguridad vial colombiana; posible anclaje teórico para el marco conceptual de la tesis. No vinculado expresamente en las fuentes a la asistencia técnica de la DCI — cualquier cruce entre ambos sería interpretación propia del autor, marcada como tal.
