---
title: "Organismos y autoridades de tránsito"
type: concepto
...
Concepto transversal que fija, desde la ley general del tránsito, quiénes son las "autoridades de tránsito" y los "organismos de tránsito" en Colombia — la categoría de actor territorial con la que trabaja directamente el procedimiento de asistencia técnica de la DCI (PR-06) y las instancias que regula PR-08.
...
- [Anexo 4 — PR-08, Instancias territoriales](../fuentes/ansv-pr-08-instancias-territoriales.md): regula la articulación de la DCI con Consejos Territoriales de Seguridad Vial (CTSV) y Comités Locales/Departamentales (CLSV/CDSV), instancias que operan sobre y con los organismos y autoridades de tránsito de cada jurisdicción definidos en la Ley 769/2002.
- [Anexo 3 — PR-07, Estrategias interinstitucionales](../fuentes/ansv-pr-07-estrategias-interinstitucionales.md) y [ANSV-CPP-PR-06](../fuentes/ansv-pr-06-procedimiento-asistencia-tecnica.md): el "municipio u organismo de tránsito" al que se dirige la asistencia técnica territorial de la DCI (objeto central de este trabajo de grado) es, precisamente, el sujeto que la Ley 769/2002 define en su Art. 6°.
