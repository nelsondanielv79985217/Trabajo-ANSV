---
title: "Sistema Seguro — enfoque de la política de seguridad vial"
type: concepto
...
[Ley 2251 de 2022](../fuentes/ley-2251-de-2022-sistema-seguro.md) ("Ley Julián Esteban"), Art. 1° (p. 1): "establecer disposiciones normativas que orienten la formulación, implementación y evaluación de la política pública de seguridad vial con el **enfoque de sistema seguro**."

Art. 2°, literal a (p. 1): "Este tiene en cuenta la vulnerabilidad de las personas a las lesiones graves causadas por accidentes de tránsito, y reconoce que el sistema se debería concebir para tolerar el error humano. La piedra angular de este enfoque son las carreteras y las bermas seguras, las velocidades seguras, los vehículos seguros y los usuarios de carreteras seguros, todo lo cual se deberá abordar con miras a poner fin a los accidentes mortales y reducir el número de lesiones graves."

Los otros tres principios que la ley asocia al Sistema Seguro (Art. 2°, lits. b–d): responsabilidad compartida entre planificadores, usuarios e iniciativa privada; seguridad vehicular (normas técnicas de diseño/fabricación); y seguridad en las vías (control operativo por cuerpos de tránsito en todo el territorio nacional). Ver texto completo en [Ley 2251 de 2022](../fuentes/ley-2251-de-2022-sistema-seguro.md).
...
**Desarrollo especializado (2026-09-25)**: el [Estado del Arte de seguridad vial de motociclistas (Consorcio Prevención Motovial)](../fuentes/producto2-estado-del-arte-motociclistas.md), producto de una consultoría supervisada por la DCI, desarrolla en profundidad y con evidencia comparada las 8 áreas de acción del Sistema Seguro aplicadas específicamente al actor vial de mayor mortalidad en Colombia (motociclistas, ≈62 % de los fallecidos viales), con hallazgos técnicos, normativos y de benchmarking internacional para cada área.

Más importante aún para el trabajo de asesoría: el PNSV **mide** esta asistencia técnica con indicadores oficiales y metas a 2031 (Tabla 18, pp. 199–200), entre ellos el más directamente ligado a Sistema Seguro: **"Municipios asistidos técnicamente en la implementación del enfoque de Sistema Seguro"** (línea base 2021: 24 %; meta 2031: 41 %; metas anuales intermedias completas en la [Estrategia de AT y Pedagógica — Acción 2.2.1](../fuentes/estrategia-asistencia-tecnica-pedagogica-sistema-seguro.md)). **Confirmado (2026-09-25)**: ese documento, propio de la DCI, establece que la fuente de información del indicador son los registros y actas de asistencia técnica "realizados por la Dirección de Coordinación Interinstitucional" — resuelve la incertidumbre de atribución para este indicador específico (ver abajo). Ver el conjunto completo de indicadores de "asistencia técnica" en [Genealogía normativa de "asistencia técnica"](genealogia-asistencia-tecnica.md).
...
- ~~No se verifica en este corpus si el Decreto 1430/2022 o el PNSV asignan expresamente a la DCI (y no solo a la ANSV en general) la ejecución de las acciones e indicadores de "asistencia técnica" que documentan.~~ **Resuelto (2026-09-25)** para el indicador "Municipios asistidos técnicamente en Sistema Seguro": la [Estrategia de AT y Pedagógica — Acción 2.2.1](../fuentes/estrategia-asistencia-tecnica-pedagogica-sistema-seguro.md), documento propio de la DCI, confirma expresamente su responsabilidad sobre ese indicador. No se verifica lo mismo para los otros cuatro indicadores de AT de la Tabla 18 del PNSV.
